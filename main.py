...
# CURP_Validator,it is a function to compare a CURP to
# a full name and obtain its individual parts.
# In this function I practice how to implement Regex and
# the different Method Types in Python.
...
class CURPValidator:
    ...
    @staticmethod
    # Finding every instance of vowels in the string
    def _find_vowel(word, pos=0):
        i = re.findall("[AEIOU]", word)
        return "X" if len(i) <= pos else i[pos]

    @staticmethod
    # Finding every instance of consonants in the string
    ...
    @staticmethod
    # It removes any instance there may be of accented letters
    ...
    @staticmethod
    # Function that matches the curp and name_map
    ...
    @staticmethod
    # In case there is an istance of a forbiden surname
